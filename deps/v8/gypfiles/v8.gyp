...

{
  'variables': {
    ...
    'torque_outputs': [
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-array-shift-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-array-shift-from-dsl-gen.h',
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-every-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-every-from-dsl-gen.h',
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-find-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-find-from-dsl-gen.h',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-findindex-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-findindex-from-dsl-gen.h',
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-some-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-typed-array-some-from-dsl-gen.h',
